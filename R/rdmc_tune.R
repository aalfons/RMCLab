...
#' or \code{\link{fold_control}()} for \eqn{K}-fold cross-validation.
...
#' @author Andreas Alfons
#' 
#' @seealso \code{\link{rdmc}()}, \code{\link{fraction_grid}()}, 
#' \code{\link{holdout_control}()}, \code{\link{fold_control}()}
#' 
